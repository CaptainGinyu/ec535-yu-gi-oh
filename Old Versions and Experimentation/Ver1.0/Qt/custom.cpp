...
QImage image2;
QImage helloScreen;
QString activeUsr, card0, card1, card0Att, card1Att, usr0Life, usr1Life;
QFile gameFile("/home/root/game.dat");
qint8 getFile;
...
{ 
    ...
    if (gameFile.open(QIODevice::ReadOnly | QIODevice::Text))
    {
        ...
        messageStream >> activeUsr >> usr0Life >> card0 >> card0Att >> usr1Life >> card1 >> card1Att;
        gameFile.close();
		getFile = 1;
    }
